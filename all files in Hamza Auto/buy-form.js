...
mainform.onsubmit = function (e) {
    ...
    function resetform() {
        if (inputOne.value !== "" && inputOne.value.length <= 20 && inputTwo.value.match(/^[Aa-z0-9_\-]+@[a-z0-9_\-]+(\.[a-z0-9_\-]+)+$/) && inputThree.value.match(/^[0-9]+$/) && inputFour.value.match(/[a-zA-Z]+/) && inputFive.value.length <= 2 && inputFive.value.match(/^[0-9]+$/) && inputSix.value == "y" || inputSix.value == "n") {
            mainform.reset()
